export const treatmentsData = [
    {
        ...
        `,
                ...
                sessionsRequired: "3-6 sessions recommended, depending on skin condition",
                suitableFor: "Adults experiencing early signs of ageing or wanting skin rejuvenation",
                aftercare: `
 ...
 
    {
        ...
        `,
                ...
                sessionsRequired: "6-8 sessions spaced 4-6 weeks apart for optimal results",
                suitableFor: "Individuals seeking permanent hair reduction or managing excess hair growth due to hormonal causes",
                aftercare: `
        ...
        `,
                ...
                sessionsRequired: "4-6 sessions, spaced 3-4 weeks apart; maintenance sessions may be recommended",
                suitableFor: "Individuals with thinning hair, early hair loss, or hair loss due to hormonal or stress-related causes",
                aftercare: `
...

    {
        ...
        `,
                ...
                sessionsRequired: "Usually 1 session per lesion; larger or multiple lesions may require multiple sessions",
                suitableFor: "Individuals with benign skin growths, warts, moles, corns, or genital warts seeking removal",
                aftercare: `
        ...
        `,
                ...
                sessionsRequired: "Multiple sessions (typically 10-20) for noticeable repigmentation",
                suitableFor: "Patients with stable vitiligo seeking repigmentation and cosmetic improvement",
                aftercare: `
...

    {
        ...
        `,
                ...
                sessionsRequired: "1 session for immediate glow; monthly sessions recommended for maintenance",
                suitableFor: "Individuals seeking radiant, hydrated, and rejuvenated skin",
                aftercare: `
...

    {
        ...
        description: `
          ...
          We offer IV drips for vitamin and nutrient replenishment, treatments for urinary incontinence, and other health-enhancing services. 
          These treatments are tailored by our specialists to support your body’s natural functions and improve overall well-being.
        `,
        benefits: [
            "Boosts immunity and overall energy levels",
            "Replenishes essential vitamins and nutrients",
            "Supports urinary and metabolic health",
            "Improves overall wellness and vitality",
            "Customized treatments for individual health needs",
        ],
        procedure: `
          - IV Drips: Administered under medical supervision to deliver vitamins, minerals, and hydration directly into the bloodstream.
          - Urinary Incontinence Treatment: Includes targeted therapies, exercises, and medications based on severity.
          - Health & Immunity Boosting Services: Personalized plans to support nutrition, detox, and wellness.
        `,
        duration: "30-60 minutes per session depending on treatment type",
        sessionsRequired: "1-10 sessions depending on individual needs and treatment type",
        suitableFor: "Individuals looking to improve overall wellness, immunity, energy levels, or manage urinary health",
        aftercare: `
          - Stay hydrated and follow any dietary or lifestyle recommendations.
          - Monitor your body’s response and report any side effects.
          - Follow-up appointments may be advised for ongoing care.
        `,
        expectedResults: `
          Improved energy, immunity, hydration, and overall well-being. 
          Specific results depend on treatment type, health condition, and adherence to recommendations.
        `,
    },
    {
        label: "Sexual Health",
        ...
        description: `
          ...
          These services are designed to enhance sexual well-being, restore confidence, and improve overall intimacy. 
          All treatments are administered under the supervision of experienced dermatology and sexual health specialists.
        `,
        benefits: [
            "Safe and effective management of genital warts",
        ...
        procedure: `
          - Genital Wart Treatment: Laser therapy, topical or minor surgical methods to safely remove warts.
          - Premature Ejaculation Management: Includes medical therapy, counseling, and behavioral techniques.
          - Non-Surgical Vaginal Tightening: Uses laser or radiofrequency therapies for tissue tightening and rejuvenation.
        `,
        duration: "30-60 minutes per session depending on treatment",
        sessionsRequired: "1-6 sessions depending on the type and severity of the condition",
        suitableFor: "Individuals seeking treatment for sexual health concerns or vaginal rejuvenation",
        aftercare: `
          - Follow prescribed medications and instructions.
          - Avoid sexual activity for recommended period post-treatment.
          - Maintain hygiene and follow-up with specialist for best outcomes.
        `,
        expectedResults: `
          Improvement in sexual health, confidence, and intimacy. 
          Genital warts are removed safely, premature ejaculation is managed effectively, and vaginal tightening enhances comfort and aesthetics. 
          Results vary depending on condition and adherence to treatment plan.
        `,
    },
];
