        ...
        <main className="relative overflow-hidden min-h-screen flex flex-col items-center justify-center 
            ...
            <div className="absolute inset-0 pointer-events-none">
                {[...Array(12)].map((_, i) => (
                    ...
                    >
                        {i % 3 === 0 && <Instagram size={28} className="text-pink-400" />}
                        {i % 3 === 1 && <Facebook size={28} className="text-blue-400" />}
                        {i % 3 === 2 && <Youtube size={28} className="text-red-500" />}
                    </div>
                ))}
            </div>

            {/* Logo in glass card with float animation */}
            <div className="p-3 rounded-full bg-white/20 backdrop-blur-md shadow-xl mb-4 
                            animate-float z-10">
                <img
                    src="/logo2.png"
