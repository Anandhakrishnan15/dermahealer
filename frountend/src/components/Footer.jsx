        ...
        <footer className="bg-[var(--sbg)] text-gray-50 py-10 px-6">
            ...
            >
                ...
                <div className="flex flex-col gap-5 animate-fadeIn">
                    ...
                    {/* Contact Info */}
                    <div className="flex flex-wrap items-center gap-6 text-sm mt-2 leading-relaxed">
                        {/* Address */}
                        <a
                        ...
                        >
                            <span className="text-xl w-6 flex-shrink-0 text-center">📍</span>
                            <span>North of Gandhi Maidan, Siwan – 841226, Bihar, India</span>
                        </a>

                        {/* Phone 1 */}
                        <a href="tel:+919931766933" className="flex items-center gap-2 hover:underline">
                            <span className="text-xl w-6 flex-shrink-0 text-center">📞</span>
                            <span>+91 9931766933</span>
                        </a>

                        {/* Phone 2 */}
                        <a href="tel:+919693601499" className="flex items-center gap-2 hover:underline">
                            <span className="text-xl w-6 flex-shrink-0 text-center">📞</span>
                            <span>+91 9693601499</span>
                        </a>

                        {/* Email */}
                        <a href="mailto:support@dermahealerindia.com" className="flex items-center gap-2 hover:underline">
                            <span className="text-xl w-6 flex-shrink-0 text-center">✉</span>
