...
export default function FinalCTA() {
    ...
    return (
        <section className="relative text-center py-16 overflow-hidden rounded-lg">
            ...
            {/* Content */}
            <h2 className="relative text-3xl font-extrabold mb-4 text-white">
            ...
            <button
                aria-label="Book your skin consultation now"
                className="relative px-8 py-3 bg-white text-teal-600 font-semibold rounded-lg shadow-lg hover:bg-gray-100 focus:ring-2 focus:ring-teal-300 transition"
